...
namespace BMCLV2.Launcher
{
	public sealed class Launcher
	{
		...
		void game_Exited(object sender, EventArgs e)
		{
			...
			if (BMCLV2.Logger.debug)
			{
				_game.OutputDataReceived -= outputLogger;
				_game.ErrorDataReceived -= errorLogger;
			}
			Gameexit();
		}
		...
		private void outputLogger(object sender, DataReceivedEventArgs e)
		{
			if (e.Data != null)
			{
		...
		private void errorLogger(object sender, DataReceivedEventArgs e)
		{
			if (e.Data != null)
			{
				foreach (var line in e.Data.Split('\n'))
